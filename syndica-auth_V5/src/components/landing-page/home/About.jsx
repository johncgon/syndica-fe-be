...
return (
    ...
    <div className="about-system-container">
        <div className="features-service-trigger w-4 h-4 absolute" id="features">{/* This component is only a trigger */}</div>
        <div className="features-container"  >
            <h2 className="features-title">Features</h2>
            <div className="features-card-container">
                <div className="features-card" ref={el => featuresCardRef.current[0] = el}>
                ...
                <div className="features-card" ref={el => featuresCardRef.current[1] = el}>
                    <div className="card-icon">
                ...
                <div className="features-card" ref={el => featuresCardRef.current[2] = el}>
                    <div className="card-icon">
        ...
        <div className="about-wrapper">
            <div className="about-system about-system-left">
                ...
                <Link to="/about" className="button-hover cursor-pointer">LEARN MORE</Link>
            </div>
