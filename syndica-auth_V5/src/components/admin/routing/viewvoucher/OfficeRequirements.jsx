...
const OfficeRequirements = () => {
  ...
  const [offices, setOffices] = useState([
    {
      name: "Issuer", // Initial office with predefined requirements
      editable: false,
      requirements: [
        { name: "Copies of DV", count: 2 },
        { name: "Pre-Repair Inspection Report", count: 1 },
        { name: "Post-Repair Inspection Report", count: 4 },
        { name: "Warranty Certificate", count: 3 },
      ],
    },
    {
      name: "Office 2", // Initial office with predefined requirements
      editable: false,
      requirements: [
        { },
      ],
