...
import '../../css/authorizer/quicksearch.css';
...
const Resultcontainer = ({ trackingNumber, status, destination, previousLocation }) => {
    return (
        <>
            <div className="authorizer__results-container w-full h-fit">
...
const QuickSearch = () => {
    return (
        <>
            <div className="authorizer__quicksearch-container w-full p-4 rounded-lg flex flex-col gap-4">
